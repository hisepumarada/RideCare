...
<meta charset="UTF-8">
	...
	<title>RideCare SHOP: Rider Appointments</title>
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
                        ...
                        <li><i class='bx bx-chevron-right' ></i></li>
						<li>
						<a class="hide" href="shopdashboard.php">Book Appointment</a>
						</li>				
					</ul>
				</div>
			</div>
...
<div class="table-data">
     <div class="order">
        ...
        {
            $usertype_id = mysqli_real_escape_string($conn, $_GET['usertype_id']);
            $query = "SELECT * FROM appointment WHERE usertype_id = '$usertype_id' ";
