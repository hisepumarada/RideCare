			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a class="hide" href="shoppaymentrider.php">Payment</a>
						</li>
                        <li><i class='bx bx-chevron-right' ></i></li>
						<li>
							<a class="hide" href="shopmessage.php">Payment</a>
						</li>
					</ul>
				</div>
			</div>
...
<br><br>
    ...
    <select required name="status" style=" padding: 8px; font-size: 16px; border: 1px solid #ccc; border-radius: 4px; background-color: #fff; color: #333; width: 200px;">
...
<script>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO payment(date, name, vehicle, status, amount, usertype_id) VALUES('$date', '$name', '$vehicle', '$status', '$amount', '$usertype_id')";
    ...
    window.location = "shoppaymentrider.php?usertype_id=<?php echo $usertype_id; ?>";
});
    <?php
        }
    } }
