...
<button  style="float: right;"class="button-3" role="button"><a href="shopchange-password.php"><h5 style="color: white;">Change Password</h5></a></button>
<br><Br>
...
if (isset($_POST['update_profile'])){
   ...
   $update_mobile = mysqli_real_escape_string($conn, $_POST['update_mobile']);
    ...
    window.location = "shopchangedetails.php";
});
    </script>  
<?php
