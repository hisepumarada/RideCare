	...
	if (empty($username)) {
		...
		if (mysqli_num_rows($result) === 1) {
            ...
            if ($row['username'] === $username && $row['password'] === $password) {
            	...
            	$_SESSION['admintype_id'] = $row['admintype_id'];
				$_SESSION["username"]=$username;
        header("Location: admindashboard.php");
		        exit();
            }
			else{
				header("Location: adminindex.php?error=Incorect Email or password");
		        exit();
			}
		}else{
			header("Location: adminindex.php?error=Incorect Email or password");
...
<head>
    ...
    <title>RideCare (ADMIN): LOGIN</title>
...
<main>
  <div class="container" >
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-4 mb-1 border-bottom">
      <a href="signup.php" class="d-flex align-items-center col-md-3 mb-2 mb-md-0 text-dark text-decoration-none">
      <svg class="bi me-2" width="10" height="50" role="img" aria-label="Bootstrap"><img src="../css/images/ridecare-high-resolution-logo-transparent.png" 
