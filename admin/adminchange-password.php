...
<button  style="float: right;"class="button-3" role="button"><a href="adminchangedetails.php"><h5 style="color: white;">Change Details</h5></a></button>
<br><Br>
...
<body>
<?php 
if (isset($_SESSION['admintype_id']) && isset($_SESSION['username'])) {
    ...
    if (isset($_POST['op']) && isset($_POST['np'])
        ...
        <?php
            ...
            $sql = "SELECT password FROM admin WHERE admintype_id='$admintype_id' AND password='$op'";
            $result = mysqli_query($conn, $sql);
            if(mysqli_num_rows($result) === 1){
                
            $sql_2 = "UPDATE admin SET password='$np' WHERE admintype_id='$admintype_id'";
    ...
    window.location = "adminchange-password.php";
});
           </script>   
    <?php
            }else {
