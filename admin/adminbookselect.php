...
while ($row = mysqli_fetch_array($result)) {
    $output .= '
        <tr>  
            ...
            <td>&nbsp;&nbsp;<button type="button" style="color: white; background: #f44336; font-size: 20px;" name="delete_btn" data-id3="' . $row["appointment_id"] . '" class="btn btn-xs btn-danger btn_delete">&nbsp;&nbsp;Delete&nbsp;&nbsp;</button>&nbsp;&nbsp;</td>  
        </tr>';
}
